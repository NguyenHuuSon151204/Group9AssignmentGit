...
namespace matchCV_Project.Services
{
    public class AccountService : IAccountService
    {
        ...
        public AccountService(MatchCvContext context, EmailService email, IConfiguration configuration)
        {
            _context = context;
            _email = email;
        ...
        {
            var key = Encoding.UTF8.GetBytes(_config["JwtKeys:PasswordResetKey"]);
